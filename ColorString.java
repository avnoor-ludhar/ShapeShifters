...
public class ColorString {
    ...
    private Appearance createAppearance(Color3f color) {
        ...
        // Key changes:
        mat.setAmbientColor(new Color3f(0.2f, 0.2f, 0.2f)); // Reduced ambient
        mat.setDiffuseColor(color);                         // Team color
        mat.setSpecularColor(new Color3f(0.7f, 0.7f, 0.7f)); // Brighter specular
